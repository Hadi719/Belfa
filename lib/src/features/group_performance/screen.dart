...
class GroupPerformanceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GetBuilder<GroupPerformanceController>(
          builder: (controller) {
            return Column(
              children: [
                ...
                Expanded(
                  child: BarChart(
                    BarChartData(
                        ...
                        bottomTitles: AxisTitles(
                          sideTitles: SideTitles(
                            ...
                            getTitlesWidget: (double value, TitleMeta meta) {
                              ...
                              if (index >= 0 &&
                                  index <
                                      controller.groupPerformanceData.length) {
                                return SideTitleWidget(
                                  ...
                                  child: RotatedBox(
                                    quarterTurns: 3,
                                    child: Text(
                                      controller.groupPerformanceData[index]
                                          .groupName,
                                    ),
                                  ),
                                );
                      ...
                      barGroups: controller.groupPerformanceData
                          .asMap()
                          .entries
                          .map(
